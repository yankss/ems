  ...
  <div>
    ...
    <!-- 面包屑导航区 -->
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>验收入库</el-breadcrumb-item>
        </el-breadcrumb>
        </div>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                icon="el-icon-check" 
                circle 
                @click="checkStorage(scope.row)"></el-button>
              </template>
            </el-table-column>
          </el-table>
   ...
   data() {
    ...
    computed: {
      tableFilterData: function() {
        return this.tableData.filter(item => item.isStorage == 0)
      }
    }
}
</script>
